...
IN_GAME_CAPTAIN_KEYBOARD_DEFAULT = [["Правила игры", "Следующий раунд", "Остановить игру"]]
IN_GAME_CAPTAIN_KEYBOARD_WHOAMI = [
    ["Правила игры", "Следующий раунд", "Раздать карточки", "Остановить игру"]
]
IN_GAME_CAPTAIN_KEYBOARD_MAFIA = [
    ["Правила игры", "Начать игру", "Раздать карточки", "Остановить игру"]
]
